...
> **历史记录。**2026-09-18 一轮通审的修复记录。第四节「误判三」提到的同名转发头已在 2026-09-19 删除，include 改为相对 `src/` 的完整路径。文中的源码路径是当时的位置，现位置见 [architecture.md §8](architecture.md#8-路径迁移对照2026-09-19)。
