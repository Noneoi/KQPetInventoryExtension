...
const QList<PacketContract>& all() {
  static const QList<PacketContract> contracts = {
      ...
      {QStringLiteral("1015_2A"), QStringLiteral("LeagueExtension"), QStringLiteral("null"), true, PacketAccess::Read,
       PacketSnapshotSemantics::Complete, PacketCorrelationStrength::CommandObserved,
       QStringLiteral("infos.UnionMemberInfo.lCToken: checked count"),
       QStringLiteral("official LeagueBaseClient.getMyLeagueInfo / LeagueMember.parse")},
